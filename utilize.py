...
def main():
    ...
    util_filenames = [filename for filename in lab_filenames if filename[:4] == "util"] + ["timer.hpp", "os.hpp", "zero_one.hpp", "element_wise.hpp", "array_matrix.hpp", "seq_io.hpp", "array_io.hpp", "vector_io.hpp"]
