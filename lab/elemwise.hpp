...
namespace std {
    ...
    // class Elemwise_impl <Derived, typename std::enable_if<std::is_complex<typename Derived::value_type>::value>::type> : public Derived::seq_type, public devel::Five_operations <Elemwise_impl <Derived>>, public devel::Five_operations <Elemwise_impl <Derived>, typename Derived::value_type>, public devel::Order_operations2 <Elemwise_impl <Derived> > {
    // public:
    //     using seq_type   = typename Derived::seq_type;
    //     using value_type = typename Derived::value_type;
    //     using type       = Elemwise_impl <Derived>;
    // private:
    //     seq_type       *seq_this;
    //     const seq_type *cseq_this;
    // public:
