...
namespace algo {
    namespace test {
        ...
        void PvC2()
        {
            game::Game G = game::Game(std::unique_ptr <game::Character>(new game::Speaker<game::Randy>("Akari", system::Playside::Alice, std::cin, std::cout)), std::unique_ptr <game::Character>(new game::Person("Me", system::Playside::Bob, std::cin,
                                                                                                                                                                               std::cout)));
            G.main();
        }
    }
